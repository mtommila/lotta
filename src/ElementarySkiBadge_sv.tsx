...
const ElementarySkiBadge_sv = (): JSX.Element => {
  return (
    <div>
      ...
      <ul>
        <li>Hur skapar du ett konditionsmärke?
          <ul>
            ...
            <li>Genom att använda trä eller metall. Ni kan till och med prova att 3D-printa ett märke, medan ni samtidigt övar på att använda Tinkercad när eleverna planerar märkets design.</li>
            <li>Obs! Kom ihåg materialmångfald och att ta till vara återvunnet material</li>
          </ul>
        </li>
      </ul>
      <ul>
      ...
      <ul>
        <li>Ställ upp 1-5 träningsmål för dig själv.</li>
      </ul>
      <ul>
      ...
      <ul>
        <li>Ordna en gemensam friluftsdag med olika aktivitetspunkter där man kan förtjäna olika konditionsmärken.</li>
      </ul>
      <ul>
        <li>Ordna rast-maraton mellan lektionerna (En överenskommen sträcka = ett poäng per klass/person). I detta maraton kan man gå, springa, åka skidor, åka skridskor etc.</li>
      </ul>
      <ul>
        <li>En friluftsdag kan ordnas i skogen eller på gården. Ni kan fundera på vilken träningsform man kan utföra där som gör att man förtjänar konditionsmärkena (naturparkour, plattformsspel).</li>
      </ul>
      <ul>
      ...
      <ul>
        <li>Ordna ett träningspass för äldre, eller planera ett streamat träningspass.</li>
      </ul>
...
export default ElementarySkiBadge_sv;
