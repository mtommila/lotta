...
const ElementaryTheatrePermit_fi = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li><a href="https://asiakas.kotisivukone.com/files/operatellus.tarjoaa.fi/Hei_tehdaan_musikaali.pdf"><strong>Hei_tehdaan_musikaali.pdf (kotisivukone.com)</strong></a></li>
        <li><a href="https://mieli.fi/fi/kirjat/el%C3%A4inlasten-el%C3%A4m%C3%A4%C3%A4-mielenterveystaitoja-p%C3%B6yt%C3%A4teatterin-keinoin"><strong>Eläinlasten elämää - Mielenterveystaitoja pöytäteatterin keinoin | MIELI Suomen Mielenterveys ry</strong></a></li>
...
export default ElementaryTheatrePermit_fi;
