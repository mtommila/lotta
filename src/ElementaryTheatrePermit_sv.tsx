...
const ElementaryTheatrePermit_sv = (): JSX.Element => {
  return (
    <div>
      ...
      <p><em>“Smålottorna samlades till handarbetskvällar där de, förutom att handarbeta, också läste och sjöng. Flickorna övade och framförde sånger, skådespel och läste både sina egna och vuxnas dikter.”</em> (Pikkulotan leikit, Perinneleikit r.y. & Lottamuseo, 2017)</p>
      ...
      <ul>
        <li>Planera och framför en liten föreställning i smågrupper (dockteater, fingerdocksteater, drama, etc.)
          <ul>
            ...
            <li>Vilka material behövs för att tillverka karaktärerna? (det kan vara udda vantar, figurer man tillverkar av papper, kartong, papplådor, naturmaterial, modellera, lera, trolldeg, etc.) Eller kanske ni agerar själva?</li>
...
export default ElementaryTheatrePermit_sv;
