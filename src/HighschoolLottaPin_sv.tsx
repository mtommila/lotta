...
const HighschoolLottaPin_sv = (): JSX.Element => {
  return (
    <div>
      <p>Lottamärket</p>
      ...
      <ul>
        <li>Betyder termerna märke och logo samma sak? Vilken används oftare nuförtiden?</li>
      </ul>
      <ul>
...
export default HighschoolLottaPin_sv;
