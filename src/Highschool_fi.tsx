...
const Highschool_fi = () => {
  return (
    <div>
      ...
      <p><em>Lottajärjestö lakkautettiin syksyllä 1944 Moskovan välirauhansopimuksen nojalla. Järjestön lakkauttamisen jälkeen lotat jatkoivat huolto- ja avustustyötä Suomen Naisten Huoltosäätiön nimissä. Vuonna 2004 Suomen Naisten Huoltosäätiön nimi muutettiin Lotta Svärd Säätiöksi.” </em><a href="https://www.lottasvard.fi/">Etusivu - Lotta Svärd - Verkkomuseo (lottasvard.fi)</a></p>
    </div>
  );
};
