...
const KindergartenMailPile_fi = (): JSX.Element => {
  return (
    <div>
      ...
      <p><em>“Viestilottien toiminimikkeitä oli muun muassa puhelunvälittäjä, radiolotta, kaukokirjoitinlotta ja salakirjoituslotta. Sotatoimialueella työskentelevät viestilotat oli yleensä sijoitettu varsinaisten viestijoukkojen viestipataljooniin.” <br /><br /></em>(<a target="_blank" rel="noreferrer" href="https://www.lottasvard.fi/lottagalleria/lottajarjeston-jaostot/#!/toimistojaviesti">Lottajärjestön jaostot - Lotta Svärd - Verkkomuseo (lottasvard.fi)</a>)</p>
